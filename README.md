...
## 시스템 구현 배경
애완동물을 키우는 1인 가구의 비율이 증가하며 비교적 관리가 쉬운 물고기를 선호하는 사람들이 증가하고 있습니다. 1인가구의 경우 장기간 외출을 하게 되면 생기는 애완동물 관리의 문제점들을 해결하기 위해 구현했습니다. 
...
## 시연 동영상 (클릭하면 유튜브로 이동)
[소개 및 수동 밥주기![소개 및 수동 밥주기](http://img.youtube.com/vi/2OseNBOGf-I/0.jpg)](https://youtu.be/2OseNBOGf-I) 
...
차후에 와이파이를 이용한 프로젝트는 좀 더 저렴하고 기타 부품들이 덜 필요한  
라즈베리 파이를 이용해야 할 것 같습니다.  
